		...
		<div class="container">
			<div class="row">
				...
				%>
						...
						<a href="updateComment.jsp?bbsID=<%= bbsID %>&commentNumber=<%= commentList.get(i).getCommentNumber() %>">수정</a>&nbsp;&nbsp;
						<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteComment.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">삭제</a><br><br>
				<%		
					}
				%>
